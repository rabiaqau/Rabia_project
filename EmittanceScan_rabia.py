...
#        print peak,"peak"
        ...
        der_sigma_a1= ( 1.0 / peak - ( (A1+A2) * der_a1 )  / peak**2 ) / math.sqrt(2*math.pi)#checked
        #print der_sigma_a1,"der_sigma_a1"

        der_sigma_a2= ( 1.0 / peak - ( (A1+A2) * der_a2 )  / peak**2 ) / math.sqrt(2*math.pi)#checked
        #print der_a2,"der_a2"
        #print der_sigma_a2,"der-sigma_a2"

        der_sigma_s1 = -( (A1+A2) * der_s1 )/ math.sqrt(2*math.pi) / peak**2#checked

#        print der_s1,"der_s1"
        #print der_sigma_s1,"der-sigma_s1"

        der_sigma_s2 = -( (A1+A2) * der_s2 ) / math.sqrt(2*math.pi) / peak**2#checked
...
#                        print len(step_5),"step_5 covarinace matrix"
                        ...
                        if result_x[1]<4 and result_y[1]<4:#chi/ndf cut
                            ...
                            # sigma error
                            rel_sigma_x = (result_x[19]/result_x[0])*100
