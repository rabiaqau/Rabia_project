...
plot( "neo/foms_trk.png", "foms_trk", peak, fom_trk, 0.9, 1.1 )
...
plot( "neo/foms_lcd.png", "foms_lcd", peak, fom_lcd, 0.9, 1.1 )
...
plot( "neo/foms_ratio.png", "foms_ratio", peak, fom_ratio, 0.9, 1.1 )
...
plot( "neo/width_x_ratio.png", "width_x_ratio", peak, width_x_ratio, 0.9, 1.1 )
...
plot( "neo/width_y_ratio.png", "width_y_ratio", peak, width_y_ratio, 0.9, 1.1 )
...
plot( "neo/peak_ratio.png", "peak_ratio", peak, peak_ratio, 0.9, 1.1 )

peak         = [ np.array([ results_trk[x][i]['peak'] for x in results_trk for i in range(len(results_trk[x])) if results_trk[x][i]['early'] == e ]) for e in [True, False] ]
peak_ratio  = [ np.array([ results_trk[x][i]['peak_exp']  for x in results_trk for i in range(len(results_trk[x])) if results_trk[x][i]['early'] == e ]) for e in [True, False] ]
plot( "neo/peak_exp_scatter.png", "peak_exp_scatter", peak, peak_ratio, 10, 80 )
...
plot( "neo/width_param_x.png", "width_param_x", peak, width_param, 0.0, 1.0 )
...
plot( "neo/width_param_y.png", "width_param_y", peak, width_param, 0.0, 1.0 )
...
width_param  = [ np.array([ results_trk[x][i]['params'][1][4]  for x in results_trk for i in range(len(results_trk[x])) if results_trk[x][i]['early'] == e ]) for e in [True, False] ]
split_param  = [ np.array([ results_trk[x][i]['params'][1][3]  for x in results_trk for i in range(len(results_trk[x])) if results_trk[x][i]['early'] == e ]) for e in [True, False] ]
plot( "neo/split_width_param_y.png", "split_width_param_y", split_param, width_param, 0.0, 1.0 )

width_param  = [ np.array([ results_trk[x][i]['params'][0][4]  for x in results_trk for i in range(len(results_trk[x])) if results_trk[x][i]['early'] == e ]) for e in [True, False] ]
split_param  = [ np.array([ results_trk[x][i]['params'][0][3]  for x in results_trk for i in range(len(results_trk[x])) if results_trk[x][i]['early'] == e ]) for e in [True, False] ]
plot( "neo/split_width_param_x.png", "split_width_param_x", split_param, width_param, 0.0, 1.0 )
...
hist = ROOT.TH1F( "chi2_x", "chi2_x", 200, 0, 100 )
for x in results_lcd:
    for i in range(len(results_lcd[x])):
        hist.Fill( results_lcd[x][i]['chi2'][0] )
hist.Draw()
canvas.Print("neo/chi2_x.png")

canvas = ROOT.TCanvas("chi2", "chi2", 800, 600)
hist = ROOT.TH1F( "chi2_y", "chi2_y", 200, 0, 100 )
for x in results_lcd:
    for i in range(len(results_lcd[x])):
        hist.Fill( results_lcd[x][i]['chi2'][1] )
hist.Draw()
canvas.Print("neo/chi2_y.png")


canvas = ROOT.TCanvas("chi2", "chi2", 800, 600)
hist = ROOT.TH1F( "chi2_comb", "chi2_comb", 200, 0, 100 )
for x in results_lcd:
    for i in range(len(results_lcd[x])):
        hist.Fill( results_lcd[x][i]['chi2'][2] )
hist.Draw()
canvas.Print("neo/chi2_comb.png")

canvas = ROOT.TCanvas("chi2", "chi2", 800, 600)
hist = ROOT.TH1F( "chi2_x", "chi2_x", 200, 0, 100 )
for x in results_trk:
    for i in range(len(results_trk[x])):
        hist.Fill( results_trk[x][i]['chi2'][0] )
hist.Draw()
canvas.Print("neo/chi2_x_trk.png")
...
hist.Draw()
canvas.Print("neo/chi2_y_trk.png")

canvas = ROOT.TCanvas("chi2", "chi2", 800, 600)
hist = ROOT.TH1F( "chi2_comb", "chi2_comb", 200, 0, 100 )
for x in results_trk:
    for i in range(len(results_trk[x])):
        hist.Fill( results_trk[x][i]['chi2'][2] )
hist.Draw()
canvas.Print("neo/chi2_comb_trk.png")
