...
#        print peak,"peak"
    ...
    return sigma, chi_NDF_double_gauss_fit, peak, chi2_double_gauss_fit, status_of_fit, staus_cov_matrix, error_peak




#,relative_a1,relative_a2, relative_s1, relative_s2, absolute_m1, absolute_m2, A1, A2, S1, S2, M1, M2
                ...
                if result_x[4]==0 and result_y[4]==0 :# converge fit
                    ...
                    if result_x[5] == 3 and result_y[5]==3: ## covariance matrix cut
                        ...
                        if result_x[1]<7 and result_y[1]<7:# chi/ndf cut
                            ...
                            histogram(100,0,4,chi2_NDF_x,"Chi_NDF_x","old_plots/Chi2_NDF_x.png","chi_NDF_x")
                            #chi2/ndf Y scan
                            chi2_NDF_y=np.append(chi2_NDF_y,result_y[1])
                            histogram(100,0,4,chi2_NDF_y,"Chi_NDF_y","old_plots/Chi2_NDF_y.png","chi_NDF_y")
...
#                            print rel_error_on_peak_x,"rel_error_on_peak_x  lenght of peak x"
                             # histogram
                            histogram(100,0.08,0.2,rel_error_on_peak_x,"rel_error_on_peak_x","old_plots/rel_error_on_peak_x.png","rel_error_on_peak_x[%]")
                            ...
                            print rel_error_on_peak_y,"rel_error_on_peak_y  "
                             # histogram
                            histogram(100,0.08,0.2,rel_error_on_peak_y,"rel_error_on_peak_y","old_plots/rel_error_on_peak_y.png","rel_error_on_peak_y[%]")
