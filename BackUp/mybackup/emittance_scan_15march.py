...
a_early_sigma_x=np.array([])
a_early_sigma_y=np.array([])
a_early_peak =  np.array([])
a_early_intensity=np.array([])
...
if fit_pickle_trk:
 ...
 #                 print len(Tight_mod[0])," lenght"
 #                 print range(len(Tight_mod))," lenght"

                  TightModSiPlusLumi= scans['TightModSiPlusLumi']
#                  print type(Tight_mod),"type of tight mod"
                  TightLumi= scans['TightLumi']
                  Tight = scans['Tight']

#                  print Tight_mod[0],"tight 0"
                  #print Tight_mod[1],"tight 1"
...
# #                        print type(list_tight_mod),"whole vector"

                        if tight_mod[4]== True:
#                              print j
#                              print tight_mod
                              early_sigma_x= tight_mod[0][0]
#                              print early_sigma_x,"sigma x"
                              
                              early_sigma_y= tight_mod[1][0]
#                              print early_sigma_y,"sigma y"
                              early_peak =  tight_mod[0][2]
#                              print early_peak,"early peak"
                              early_intensity= tight_mod[2]
#                              print early_intensity,"intensity"
#                              print expected_luminosity(early_sigma_x,early_sigma_y,early_intensity)
#                              print expected_luminosity(early_sigma_x,early_sigma_y,early_intensity) -early_peak,"diff"
...
#                              print late_sigma_x,"sigma x"
                              
                              late_sigma_y= tight_mod[1][0]
#                              print late_sigma_y,"sigma y"
                              late_peak =  tight_mod[0][2]
#                              print late_peak,"late peak"
                              late_intensity= tight_mod[2]
#                              print late_intensity,"intensity"
#                              print expected_luminosity(late_sigma_x,late_sigma_y,late_intensity)
#                              print expected_luminosity(late_sigma_x,late_sigma_y,late_intensity) -late_peak,"diff"
#                              print late_peak/expected_luminosity(late_sigma_x,late_sigma_y,late_intensity),"fom late"
                  ...
                  for m in range(len(TightModSiPlusLumi)):
                        ...
                        if tight_mod_si_plus_lumi[4]== True:
                              ...
                              #print j
                              #print tight_mod_si_plus_lumi
                              early_tm_si_plus_sigma_x= tight_mod_si_plus_lumi[0][0]
                              #print early_tm_si_plus_sigma_x,"sigma x"
                              
                              early_tm_si_plus_sigma_y= tight_mod_si_plus_lumi[1][0]
                              #print early_tm_si_plus_sigma_y,"sigma y"
                              early_tm_si_plus_peak =  tight_mod_si_plus_lumi[0][2]
                              #print early_tm_si_plus_peak,"early peak"
                              early_tm_si_plus_intensity= tight_mod_si_plus_lumi[2]
                              #print early_tm_si_plus_intensity,"intensity"
                              #print expected_luminosity(early_tm_si_plus_sigma_x,early_tm_si_plus_sigma_y,early_tm_si_plus_intensity)
                              #print expected_luminosity(early_tm_si_plus_sigma_x,early_tm_si_plus_sigma_y,early_tm_si_plus_intensity) -early_tm_si_plus_peak,"diff"
                              ...
                              print early_tm_si_plus_fom,"early fom"
...
###################################
                        ...
                        if tight_mod_si_plus_lumi[4]== False:
                              ...
                              #print late_tm_si_plus_sigma_x,"sigma x"
                              
                              late_tm_si_plus_sigma_y= tight_mod_si_plus_lumi[1][0]
                              #print late_tm_si_plus_sigma_y,"sigma y"
                              late_tm_si_plus_peak =  tight_mod_si_plus_lumi[0][2]
                              #print late_tm_si_plus_peak,"late peak"
                              late_tm_si_plus_intensity= tight_mod_si_plus_lumi[2]
                              #print late_tm_si_plus_intensity,"intensity"
                              #print expected_luminosity(late_tm_si_plus_sigma_x,late_tm_si_plus_sigma_y,late_tm_si_plus_intensity)
                              #print expected_luminosity(late_tm_si_plus_sigma_x,late_tm_si_plus_sigma_y,late_tm_si_plus_intensity) -late_tm_si_plus_peak,"diff"
                              ...
                              print late_tm_si_plus_fom,"late fom"
...
#                              a_early_sigma_x=np.append(a_early_sigma_x,early_sigma_x)
                              
#                               a_early_sigma_y=np.append(a_early_sigma_y,early_sigma_y)
#                               a_early_peak = np.append( a_early_peak,early_peak)


#                               exp= expected_luminosity(a_early_sigma_x,a_early_sigma_y,early_intensity)

#                               a_early_intensity=np.append(a_early_intensity,early_intensity)
#                               print np.divide(a_early_peak,exp),"fom"




                              
#                              fom = fom(a_early_sigma_x,a_early_sigma_y,a_early_intensity,a_early_peak)
#                              print fom,"fom early"
                        # if tight_mod[4]== False:
                        #       print j
                        #       fom = fom(tight_mod[0][0],tight_mod[1][0],tight_mod[2],tight_mod[0][2])
                        #       print fom,"fom late"

                              

                        #       print tight_mod[0][0],"tight mod 0"
                        #       print tight_mod[1][0],"tight mod 1"
                        #       print tight_mod[0][2],"peak late"
                        #       print tight_mod[2],"intebnsity late"

#                        print tight_mod[1][1]
#                        print tight_mod[3]
                        
#
#                        print tight_mod_early[1]
#                        print tight_mod[1]
                        # tight_mod_early_sigma_x=  tight_mod_early[0][0]
                        # tight_mod_early_sigma_y =  tight_mod_early[1][0]
                        # tight_mod_early_intensity=  tight_mod_early[2]
                        # tight_mod_early_peak= tight_mod_early[0][2]
#                   tight_mod_early_fom= fom(tight_mod_early_sigma_x,tight_mod_early_sigma_y,tight_mod_early_intensity,tight_mod_early_peak)
#                   print tight_mod_early_fom,"fom"


#                   tight_mod_late =  workingpoint(analyse_scan, Tight_mod[1])
                  
#                   tight_mod_late_sigma_x=  tight_mod_late[0][0]
#                   tight_mod_late_sigma_y =  tight_mod_late[1][0]
#                   tight_mod_late_intensity=  tight_mod_late[2]
#                   tight_mod_late_peak= tight_mod_late[0][2]
#                   tight_mod_late_fom= fom(tight_mod_late_sigma_x,tight_mod_late_sigma_y,tight_mod_late_intensity,tight_mod_late_peak)
#                   print tight_mod_late_fom,"fom"
...
#                  fom(sigma_x,sigma_y,intensity,peak)
 
                  # here late scan 
#                 print test(analyse_scan, Tight_mod[0]),"for early scan"
#                  fom(sigma_x,sigma_y,intensity,peak)
...
#                               #print fom_late_Tight_mod,"late tight mod"
#                   if Tight_mod== False and TightLumi == True and Tight== False and TightModSiPlusLumi==False:
# #                  if Tight_mod== False,TightModSiPlusLumi== True, TightLumi== False, Tight== False :
#                   #tight mod si plus lumi
#                         for i in range(len(TightModSiPlusLumi)):
#                               output_TightModSiPlusLumi = TightModSiPlusLumi[i]

#                               i_sep_x = output_TightModSiPlusLumi['sep_x']
#                               i_exp_lumi_x = output_TightModSiPlusLumi['exp_lumi_x']
#                               i_err_x = output_TightModSiPlusLumi['err_x']
#                               i_curr_0 = output_TightModSiPlusLumi['curr'][0]
#                               i_date = output_TightModSiPlusLumi['date']

#                               i_sep_y = output_TightModSiPlusLumi['sep_y']
#                               i_exp_lumi_y = output_TightModSiPlusLumi['exp_lumi_y']
#                               i_err_y = output_TightModSiPlusLumi['err_y']
#                               i_curr_1 = output_TightModSiPlusLumi['curr'][1]

#                               i_run = output_TightModSiPlusLumi['run']
#                               i_bunches= output_TightModSiPlusLumi['bunches']
#                               i_early = output_TightModSiPlusLumi['early']
#                               i_result_x = analyse_scan(i, i_sep_x, i_exp_lumi_x ,i_err_x ,"Emittance_scan/", i_run, i_bunches, i_curr_0,True, i_early,i_date )
#                               i_result_y = analyse_scan(i, i_sep_y, i_exp_lumi_y ,i_err_y ,"Emittance_scan/", i_run, i_bunches, i_curr_1,False, i_early,i_date)


#                               if output_TightModSiPlusLumi['early'] == True:

                              
#                                     i_expected_lumi_early= expected_luminosity(i_result_x[0],i_result_y[0],intensity_tight_mod[0] )
#                                     mu_early_TightModSiPlusLumi= np.append(mu_early_TightModSiPlusLumi,i_result_x[2])
                                    
#                                     fom_e_tight_si_plus = i_result_x[2]/ i_expected_lumi_early

#                                     fom_early_TightModSiPlusLumi= np.append(fom_early_TightModSiPlusLumi ,fom_e_tight_si_plus)

#                                     print fom_early_TightModSiPlusLumi,"early si"


#                               # print i_expected_lumi_early,"expected lumi early tightsi "
#                               # print ,"peak_early tight si"


#                               if output_TightModSiPlusLumi['early'] == False:


                                    
#                                     i_expected_lumi_late= expected_luminosity(i_result_x[0],i_result_y[0], intensity_tight_mod[1])
#                               # print i_expected_lumi_late,"expected late tight si"
#                               # print ,"peak laet tight si"
                              

#                                     fom_l_tightmodsiplus = i_result_x[2]/i_expected_lumi_late
#                                     mu_late_TightModSiPlusLumi= np.append(mu_late_TightModSiPlusLumi,i_result_x[2])

#                                     fom_late_TightModSiPlusLumi=np.append(fom_late_TightModSiPlusLumi ,fom_l_tightmodsiplus)
#                                     print fom_late_TightModSiPlusLumi,"late si"
...
#                   for i_scan_TightLumi in range(len(TightLumi)):
#                         output_TightLumi = TightLumi[i_scan_TightLumi]
                        
#                         TightLumisep_x = output_TightLumi['sep_x']
#                         TightLumiexp_lumi_x = output_TightLumi['exp_lumi_x']
#                         TightLumierr_x = output_TightLumi['err_x']
#                         TightLumicurr_0 = output_TightLumi['curr'][0]
#                         TightLumidate = output_TightLumi['date']
                        
#                         TightLumisep_y = output_TightLumi['sep_y']
#                         TightLumiexp_lumi_y = output_TightLumi['exp_lumi_y']
#                         TightLumierr_y = output_TightLumi['err_y']
#                         TightLumicurr_1 = output_TightLumi['curr'][1]

#                         TightLumirun = output_TightLumi['run']
#                         TightLumibunches= output_TightLumi['bunches']
#                         TightLumiearly = output_TightLumi['early']

#             #print fom_alex,"fom Alex"                                                                                                        
#                         result_x_TightLumi = analyse_scan(i_scan_TightLumi, TightLumisep_x, TightLumiexp_lumi_x ,TightLumierr_x ,"Emittance_scan/", TightLumirun, TightLumibunches, TightLumicurr_0, True, TightLumiearly,TightLumidate )
#                         result_y_TightLumi = analyse_scan(i_scan_TightLumi, TightLumisep_y, TightLumiexp_lumi_y ,TightLumierr_y ,"Emittance_scan/", TightLumirun, TightLumibunches, TightLumicurr_1, False, TightLumiearly,date)
                        
#                         if output_TightLumi['early'] == True:
#                               expected_TightLumi= expected_luminosity(result_x_TightLumi[0],result_y_TightLumi[0], intensity_tight_mod[0])
#                               fom_e_tightlumi= result_x_TightLumi[2]/expected_TightLumi

#                               fom_early_TightLumi= np.append(fom_early_TightLumi,fom_e_tightlumi)



#                               mu_early_TightLumi= np.append(mu_early_TightLumi,result_x_TightLumi[2])





#                               #print fom_early_TightLumi,"early tight lumi"
#                               # print result_x_TightLumi[0],"x result"
#                               # print result_y_TightLumi[0],"x result"
                              
#                               # print intensity_tight_mod[0],"intensity"
#                               # print expected_TightLumi,"early tightlumi"
#                               # print ,"early peak tightlumi"

#                         if output_TightLumi['early'] == False:
   
#                               expected_TightLumi= expected_luminosity(result_x_TightLumi[0],result_y_TightLumi[0], intensity_tight_mod[1])



#                               fom_l_tightlumi = result_x_TightLumi[2]/expected_TightLumi
#                               mu_late_TightLumi= np.append(mu_late_TightLumi,result_x_TightLumi[2])
#                               fom_late_TightLumi= np.append(fom_late_TightLumi,fom_l_tightlumi)
#                               #print fom_late_TightLumi,"late tight lumi"
#                               # print expected_TightLumi,"late tightlumi"
#                               # print result_x_TightLumi[2],"late peak tightlumi"

#                   # tight 
#                   for i_scan_Tight in range(len(Tight)):
#                         output_Tight = Tight[i_scan_Tight]                        
#                         Tightsep_x = output_Tight['sep_x']
#                         Tightexp_lumi_x = output_Tight['exp_lumi_x']
#                         Tighterr_x = output_Tight['err_x']
#                         Tightcurr_0 = output_Tight['curr'][0]
#                         Tightdate = output_Tight['date']
                        
#                         Tightsep_y = output_Tight['sep_y']
#                         Tightexp_lumi_y = output_Tight['exp_lumi_y']
#                         Tighterr_y = output_Tight['err_y']
#                         Tightcurr_1 = output_Tight['curr'][1]

#                         Tightrun = output_Tight['run']
#                         Tightbunches= output_Tight['bunches']
#                         Tightearly = output_Tight['early']

#             #print fom_alex,"fom Alex"                                                                                                        
#                         result_x_Tight = analyse_scan(i_scan_Tight, Tightsep_x, Tightexp_lumi_x ,Tighterr_x ,"Emittance_scan/", Tightrun, Tightbunches, Tightcurr_0, True, Tightearly,Tightdate )
#                         result_y_Tight = analyse_scan(i_scan_Tight, Tightsep_y, Tightexp_lumi_y ,Tighterr_y ,"Emittance_scan/", Tightrun, Tightbunches, Tightcurr_1, False, Tightearly,Tightdate)




#                         if output_Tight['early'] == True:
#                               expected_Tight= expected_luminosity(result_x_Tight[0],result_y_Tight[0], intensity_tight_mod[0])
#                               # print result_x_Tight[0]
#                               # print result_y_Tight[0]

#                               fom_e_tight= result_x_Tight[2]/expected_Tight
#                               # print expected_Tight,"early tight"
#                               # print result_x_Tight[2],"early peak tight"
#                               mu_early_Tight= np.append(mu_early_Tight,result_x_Tight[2])



#                               fom_early_Tight= np.append(fom_early_Tight,fom_e_tight)
#                               #print fom_early_Tight,"tight  ear;ly"




#                         if output_Tight['early'] == False:

#                               expected_Tight= expected_luminosity(result_x_Tight[0],result_y_Tight[0], intensity_tight_mod[1])
#                               fom_l_tight= result_x_Tight[2]/expected_Tight
#                               # print expected_Tight,"late tight"
#                               # print result_x_Tight[2],"late peak tight"
#                               mu_late_Tight= np.append(mu_late_Tight,result_x_Tight[2])
#                               fom_late_Tight= np.append(fom_late_Tight,fom_l_tight)
#                               #print fom_late_Tight,"tight late"
...
# multigraph("latest/fomvsmu_tightmod.png", len(mu_early_Tight_mod), len(mu_late_Tight_mod),mu_early_Tight_mod ,fom_early_Tight_mod ,mu_late_Tight_mod, fom_late_Tight_mod)
...
# ratio_Tight_mod_TightLumi= np.divide(fom_TightModSiPlusLumi ,fom_Tight_mod)
...
# plot_graph ("latest/ratio_Tight_mod_TightModSiPlusLumi.png", "ratio_Tight_mod_TightModSiPlusLumi", len(el_mu_Tight_mod), run, ratio_Tight_mod_TightModSiPlusLumi, "run","TightModSiPlusLumi/tightmod")
