...
fit_pickle = sorted(glob.glob("fits_4WP/integrated/fit_integrated_trk_run_349014.pickle"))
...
for filename in fit_pickle:
    with open(filename,'rb') as fit_pickle:
        ...
        for i_scan in range(len(scans)):
            ...
            #         if result_x[5] == 3: ## covariance matrix cut


                        
            #             if result_x[1]<4 : # chi/ndf cut
            ...
            #                  # histogram
            #                 histogram(100,0,5,rel_error_on_peak_x,"rel_error_on_peak_x","plots/rel_error_on_peak_x.png","rel_error_on_peak_x[%]")
    

            #             # relative error on a1
            #                 rel_error_on_a1_x = np.append(rel_error_on_a1_x, result_x[7])
            #             # histogram
            #                 histogram(100,0,20,rel_error_on_a1_x,"rel_error_on_a1_x","plots/rel_error_on_a1_x.png","rel_error_on_a1_x[%]")
                        
                        
            #             # relative error on a2
            #                 rel_error_on_a2_x = np.append(rel_error_on_a2_x, result_x[8])
            #             # histogram
            #                 histogram(100,0,40,rel_error_on_a2_x,"rel_error_on_a2_x","plots/rel_error_on_a2_x.png","rel_error_on_a2_x[%]")
            ...
            #             # histogram
            #                 histogram(100,0,20,rel_error_on_s1_x,"rel_error_on_s1_x","plots/rel_error_on_s1_x.png","rel_error_on_s1_x[%]")
                        
                        
            #             # relative error on a2
            #                 rel_error_on_s2_x = np.append(rel_error_on_s2_x, result_x[10])
            #             # histogram
            #                 histogram(100,0,20,rel_error_on_s2_x,"rel_error_on_s2_x","plots/rel_error_on_s2_x.png","rel_error_on_s2_x[%]")
            ...
            #             # histogram
            #                 histogram(100,-0.0001,0.1,abs_error_on_m1_x,"abs_error_on_m1_x","plots/abs_error_on_m1_x.png","abs_error_on_m1_x[%]")
                        
                        
            #             # absolute error on m2
            #                 abs_error_on_m2_x = np.append(abs_error_on_m2_x, result_x[12])
            #             # histogram
            #                 histogram(100,-0.0001,0.1,abs_error_on_m2_x,"abs_error_on_m2_x","plots/abs_error_on_m2_x.png","abs_error_on_m2_x[%]")
            ...
            #                 histogram(100,0,1,fit_A1_x,"fit_A1_x","plots/fit_A1_x.png","fit_A1_x[value]")

            #                 histogram(100,0,2,fit_A2_x,"fit_A2_x","plots/fit_A2_x.png","fit_A2_x[value]")

            #                 histogram(100,0.01,0.02,fit_S1_x,"fit_S1_x","plots/fit_S1_x.png","fit_S1_x[value]")
                        
            #                 histogram(100,0.01,0.04,fit_S2_x,"fit_S2_x","plots/fit_S2_x.png","fit_S2_x[value]")
