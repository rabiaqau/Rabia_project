...
#    print (error_s1/s1)*100 ,"sigma error"
    ...
    if run_number== 349533:
        ...
        if Xscan:
            double_gauss_fit.SetParameter(5,1.3*m1)
            double_gauss_fit.SetParameter(2,s1)
    ...
    if run_number==349481:
        if early and Xscan:
            ...
            double_gauss_fit.SetParameter(2,s1*1.4)
            double_gauss_fit.SetParameter(0,amplitude*0.6)
            double_gauss_fit.SetParameter(3,amplitude*0.4)
    ...
    if run_number== 349169:#### x early scan is still problem
        ...
        if early and Xscan:
            double_gauss_fit.SetParameter(4,1.08*s1)
            double_gauss_fit.SetParameter(2,1.0098*s1)
            double_gauss_fit.SetParameter(0,amplitude*0.25)
            double_gauss_fit.SetParameter(3,amplitude*0.79)
...
#            double_gauss_fit.SetParameter(4,s1)
    ...
    if run_number==349111:
        if Xscan:
            double_gauss_fit.SetParameter(4,s1)
            double_gauss_fit.SetParameter(0,amplitude*0.37)
            double_gauss_fit.SetParameter(3,amplitude*0.65)
    ...
    if run_number==359191:
        if early and Xscan:
            double_gauss_fit.SetParameter(4,s1*1.38)
            double_gauss_fit.SetParameter(0,amplitude*0.37)
            double_gauss_fit.SetParameter(3,amplitude*0.67)
        if not early and not Xscan:
            double_gauss_fit.SetParameter(0,amplitude*0.37)
    ...
    if run_number==357887:
        ...
        if not early and not Xscan:
            double_gauss_fit.SetParameter(1,-m1*0.5)
            double_gauss_fit.SetParameter(4,1.099*s1)
...
#            double_gauss_fit.SetParameter(4,s1*2)
    ...
    if run_number==350067:
        ...
        if Xscan:
            ...
            double_gauss_fit.SetParameter(0,amplitude*0.787758)
    ...
    if run_number==349841:
        if Xscan:
            double_gauss_fit.SetParameter(1,m1*2)
    ...
    if run_number==349327:
        if Xscan:
            double_gauss_fit.SetParameter(0,amplitude)
            double_gauss_fit.SetParameter(3,amplitude*0.01)
            double_gauss_fit.SetParameter(2,s1*2)
...
if fit_pickle_trk:
  ...
  #          print type(scan),"scan"
   ...
   #         print scans,"scanas"
 #           print type(scan['TightModLumi']),"scantightmod type"
#        scans = scan['Tight']
